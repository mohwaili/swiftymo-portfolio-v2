            ...
            <ScrollArea className="h-[400px]">
              <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                {experience.map((item: Experience, index: number) => (
                  <li
                    key={index}
                    className="bg-[#232329] min-h-[184px] py-6 px-10 rounded-xl flex flex-col justify-start items-center lg:items-start gap-1"
                  >
                    ...
                    {item.achievements && (
                      ...
                      {item.achievements.map((achievement, index) => (
                        <li key={index} className="flex items-start gap-2 text-white/60 text-sm leading-snug text-left">
                          <span className="w-[6px] h-[6px] rounded-full bg-accent shrink-0 mt-[6px]" />
                          {achievement}
                        </li>
                      ))}
                    </ul>
